...
const Header = () => {
  ...
  return (
    <header className='fixed top-0 left-0 right-0 z-30 flex justify-between items-center md: py-8 px-5 md:px-0 container mx-auto'>
      <img className='w-[50%] md:w-[30%] z-20' src={logo} alt='logo image'/>
